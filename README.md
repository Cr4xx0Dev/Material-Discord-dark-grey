...
> [!IMPORTANT]
> **Files now available:** The theme files have been uploaded to the repository and are ready to use. 

---

## About the Project

I had some free time and was a bit bored, so I decided to create a fork of Material Discord.
...
```css
@import url("https://raw.githubusercontent.com/Cr4xx0Dev/Material-Discord-dark-grey/main/material-discord.theme.css");
```

### Method 2: Manual Download
1. Download the repository or theme file.
2. Place the file into your client mod's themes folder.
3. Enable the theme in your Discord settings.
